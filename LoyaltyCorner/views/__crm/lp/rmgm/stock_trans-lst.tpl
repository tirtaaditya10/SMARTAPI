...
{/block}
{block name="th_ext"}
    {include file="{$sys.uix.elm}/tbl/th_col.tpl" label="Type" field="wcrm_inventory_direction"}
    ...
    {include file="{$sys.uix.elm}/tbl/th_col.tpl" label="Trans Category" field="wcrm_inventory_category"}
...
{/block}
{block name="td_ext"}
    <td>{$i.wcrm_inventory_direction}</td>
    <td>{$i.wcrm_reward}</td>
    <td>{$i.wcrm_warehouse}</td>
    <td>{$i.wcrm_inventory_category}</td>
    <td>{$i.qty}</td>
    <td>{$i.reference}</td>
