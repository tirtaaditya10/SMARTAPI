...
{/block}
{block name="th_ext"}
	 {include file="{$sys.uix.elm}/tbl/th_col.tpl" label="RESULT" field="wcrm_camp_conf_result"}

	 {include file="{$sys.uix.elm}/tbl/th_col.tpl" label="SUB RESULT" field="wcrm_camp_conf_result_sub"}
{/block}
{block name="td_ext"}
