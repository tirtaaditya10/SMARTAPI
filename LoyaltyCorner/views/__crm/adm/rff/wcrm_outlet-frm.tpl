<form id="F{$sys.req.rid}{$sys.req.pid}" method="post" action="#{$sys.req.rid}/{$sys.req.pid}" class="cForm form-horizontal" role="form">
    <fieldset>
        ...
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl" label="OUTLET NAME"     name="wcrm_outlet" required=true}
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl" label="OUTLET GROUP" 	name="wcrm_outlet_group" required=true}

        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl" label="CITY" 	name="wcrm_city" required=true}
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_select.tpl" rff=$sys.rsp.ref.wcrm_region label="active"}
