<form id="F{$sys.req.rid}{$sys.req.pid}" method="post" action="#{$sys.req.rid}/{$sys.req.pid}" class="cForm form-horizontal" role="form">
    <fieldset>
        ...
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_select.tpl" rff=$sys.rsp.ref.wcrm_km_category}
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl" label="Sub Category" 	name="wcrm_km_category_sub" required=true}
