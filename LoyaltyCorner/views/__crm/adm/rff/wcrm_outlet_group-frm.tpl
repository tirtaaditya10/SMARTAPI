<form id="F{$sys.req.rid}{$sys.req.pid}" method="post" action="#{$sys.req.rid}/{$sys.req.pid}" class="cForm form-horizontal" role="form">
    <fieldset>
        ...
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl" label="Group Name" 	name="wcrm_outlet_group" required=true}
        {include file="{$sys.uix.elm}/frm/bs-hrz/elm_select.tpl" rff=$sys.rsp.ref.wcrm_channel_trade}
