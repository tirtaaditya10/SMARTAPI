								...
								<table class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th width="10%"><center>Campaign Result</th>
									...
									<tbody>	
                                        ...
                                        ?>
										<tr>
                                            <td><center><a href="#cc/cca/my_detail/<?php echo $key->phone; ?>"><span class="glyphicon glyphicon-earphone"> [call]</span> </a></td>
											<td><?php echo $key->callStatus; ?></td>
											<td><?php echo $key->aaa_account; ?></td>
