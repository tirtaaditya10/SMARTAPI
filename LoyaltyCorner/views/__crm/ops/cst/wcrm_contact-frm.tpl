<fieldset>
    ...
    <div class="row">
        <section class="col-md-5">
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_dual.tpl"              cfg_1=[type=>"text", readonly=>1]       cfg_2=[type=>"number", readonly=>1]
                grid_12=6
                label_1="Mom / Dad"         name_1="wcrm_account"
                                            name_2="id"}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="Children"    name="wcrm_contact" cfg=[required=>1, readonly=>1]}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_dual.tpl"              grid_22=6 cfg_1=[type=>"date_view"]     cfg_2=[type=>"text", readonly=>1]
            ...
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="Prev. Product"       name="wcrm_product_list_prev"   cfg=[readonly=>1]}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="Actual Product"      name="wcrm_product_list_actual" cfg=[readonly=>1]}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_dual.tpl"              cfg_1=[type=>"text", readonly=>1]       cfg_2=[type=>"text", readonly=>1]
                label_1="Usage Duration"    name_1="wcrm_duration_of_use"   grid_12=4 grid_21=2
                label_2="Usage Length"      name_2="age_usage"}
        </section>
        <section class="col-md-7">
            ...
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="BP"    name="wcrm_brand_presenter" cfg=[readonly=>1]}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_dual.tpl"              cfg_1=[type=>"text", readonly=>1]       cfg_2=[type=>"number", readonly=>1]
            ...
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="Gimmick"     name="wcrm_gimmick"     cfg=[readonly=>1]}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_text.tpl"              label="Batch"       name="upl_action"       cfg=[readonly=>1]   value="#{$sys.rsp.dat.upl_action_id} {$sys.rsp.dat.upl_action}"}
            {include file="{$sys.uix.elm}/frm/bs-hrz/elm_dual.tpl"              cfg_1=[type=>"text", readonly=>1]       cfg_2=[type=>"date_view", format=>"%d-%b-%Y %H:%M"]
