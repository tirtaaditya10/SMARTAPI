<div class="form-group {$display|default:''}" {if isset($msg_helper)}style="margin-bottom:0"{/if}>
	<label for="{$name1}" class="col-md-{$WLbl|default:3} control-label">{$label} {if isset($required1) || isset($required2)}<span class="required">*</span>{else}&nbsp;{/if}</label>
	<div class="col-md-4">
		<div class="input-group date date_picker {$dpClass|default:''}" data-date-format="yyyy-mm-dd">
			...
			/>
			<span class="input-group-btn"><button class="btn default" type="button" style="margin-bottom: 0;"><i class="fa fa-calendar"></i></button></span>
		</div>
