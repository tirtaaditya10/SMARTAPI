...
<div class="form-group{$display}">
	...
	<div class="col-md-{$WElm|default:9}">
		<div class="input-group input-{$size|default:'small'}">
			<input type="number" id="{$name}_{$sys.req.rid}" name="{$name}" class="form-control" value="{$sys.rsp.dat.$name|default:'$default'}"
