...
<div class="form-group{$display}">
	...
	<div class="col-md-{$WElm|default:3}">
		<div class="input-group input-icon right">
			...
			<i class="fa"></i>
			<input type="number" id="{$name}_{$sys.req.rid}" name="{$name}" class="form-control text-right" value="{$sys.rsp.dat.$name|default:''}"
		...
		<span id="{$name}_error" class="help-block">{$msg_helper|default:''}</span>
	</div>
</div>
